...
from utils import test_trajectory_error, calculate_length, transfer_table_to_matrix
...
parser.add_argument('--simulation_num', type=int, default=10000000)
...
if load_dir_id:
    ...
    with open(f'{load_dir}logger_test_error_rate.pkl', 'rb') as f:
    ...
    with open(f'{load_dir}logger_test_fake_true_rate.pkl', 'rb') as f:
        logger_test_fake_true_rate = pickle.load(f)
    with open(f'{load_dir}logger_test_length_rate_avg.pkl', 'rb') as f:
        logger_test_length_rate_avg = pickle.load(f)
    with open(f'{load_dir}logger_test_leng_10_rate.pkl', 'rb') as f:
